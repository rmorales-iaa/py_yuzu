...
import logging
from pathlib import Path  # noqa: F401 (kept for compatibility / future use)
...
class OptionGroup:
    ...
    def add_option(self, *opts, **kwargs):
        # Back-compat with older code that called add_option(...)
...
# Option descriptions (kept in 'optparse'-style text for compatibility)
desc: dict[str, str] = {}

filterk = "FILTER"
desc["filterk"] = "keyword for the name of the filter of the observation [default: %default]"
