...
class FuncCatchllallTest(unittest.TestCase):
    def test_func_catchall(self):
        ...
        self.assertEqual(3, util.func_catchall(operator.truediv, 9, 3))
        ...
        self.assertEqual(None, util.func_catchall(operator.truediv, 1, 0))
...
class StreamToWarningFilterTest(unittest.TestCase):
    def test_filter_stream(self):
        ...
        with warnings.catch_warnings():
            ...
            with self.assertRaisesRegex(category, expected_output):
