...
class SNRTest(unittest.TestCase):
    def setUp(self):
        ...
        self.random_snrs = (random.uniform(MIN_SNR, MAX_SNR) for x in range(NITERS))
    ...
    def test_difference_error(self):
        ...
        for _ in range(NITERS):
            ...
            stars = [self._random_magnitude_error() for _ in range(how_many)]
    ...
    def test_difference_snr(self):
        ...
        for _ in range(NITERS):
            how_many = random.randint(MIN_NERR, MAX_NERR)
            errors = [self._random_error() for i in range(how_many)]
    ...
    def test_weighted_mean_error(self):
        ...
        for _ in range(NITERS):
            how_many = random.randint(MIN_NERR, MAX_NERR)
            errors = [self._random_error() for _ in range(how_many)]
            expected_err = mean_error(errors)
    ...
    def test_weighted_mean_snr(self):
        ...
        for _ in range(NITERS):
            how_many = random.randint(MIN_NERR, MAX_NERR)
            errors = [self._random_error() for i in range(how_many)]
            weights = [self._random_weight() for i in range(how_many)]
